        ...
        <td align="center" valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="1089" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>订单列表</b>
                    </td>
    ...
    <tr>
        <td height="24" align="right">当前页数：[<%=Page%>/<%=maxPage%>]&nbsp;
            ...
            <%
                ...
                if (Page < maxPage) {
            %>
            　<a href="ordermanage.jsp?Page=<%=Page + 1%>">下一页</a>　<a
                    href="ordermanage.jsp?Page=<%=maxPage%>">最后一页&nbsp;</a>
            <%
                }
            %></td>
    </tr>
