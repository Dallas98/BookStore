...
<table width="199" height="431" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td colspan="3" align="center" valign="top" background="images/manage_rightKmid.GIF">
            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="20%" height="50" align="center" class="tableBorder_B_dashed"><img
                            src="images/manage_listIco.GIF" width="10" height="11"/></td>
                    <td width="80%" class="tableBorder_B_dashed"><a href="index.jsp">图书管理<br>
                        Book Manage</a></td>
                </tr>
                <tr>
                    <td height="50" align="center" class="tableBorder_B_dashed"><img src="images/manage_listIco.GIF"
