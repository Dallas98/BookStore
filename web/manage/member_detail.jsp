        ...
        <td align="center" valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="1070" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>会员详细信息</b>
                    </td>
            ...
            <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder">
                ...
                <tr>
                    ...
                    <td height="14" class="tableBorder_B_dashed">&nbsp;<%=Truename%>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td height="14" class="tableBorder_B_dashed">&nbsp;<%=address%>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td height="14" class="tableBorder_B_dashed">&nbsp;<%=CardType%>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="tableBorder_B_dashed">&nbsp;<%=Tel%>
                    </td>
                </tr>
                <tr>
                    <td height="27" align="center" class="tableBorder_B_dashed">&nbsp;Email：</td>
                    <td class="tableBorder_B_dashed">&nbsp;<%=Email%>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td height="38" colspan="2" align="center">
                        ...
                        <input name="Submit3" type="button" class="btn_bg_short" value="返回"
                               onClick="JScript:history.back()"></td>
                </tr>
            </table>
            <!---->
        </td>
