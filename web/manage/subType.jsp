        ...
        <td align="center" valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td colspan="3" class="tableBorder_B_dashed"><img src="images/manage_ico2.GIF" width="11"
                                                                      height="11">&nbsp;<a
                            href="sub_add.jsp">[添加小分类信息]</a></td>
                    <td width="12">&nbsp;</td>
                </tr>
                <tr>
                    <td align="right">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td width="1089" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>小分类信息列表</b>
                    </td>
                        ...
                        <td valign="top">
                            ...
                            <table width="100%" height="48" border="1" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="padding:5px;">
                                    <td height="20" align="center"><%=superType%>
                                    </td>
                                    <td height="20" align="center"><%=subType%>
                                    </td>
                                    <td align="center"><input name="delid" type="checkbox" class="noborder"
                                                              value="<%=ID%>"></td>
                                </tr>
                                <%
                                    }
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <td width="27%" align="right"><input name="checkbox" type="checkbox"
                                                                         class="noborder"
                                                                         onClick="CheckAll(frm.delid,frm.checkbox)">
                                        [全选/反选] [<a style="color:red;cursor:hand;"
                                                    onClick="checkdel(frm.delid,frm)">删除</a>]
                                        <div id="ch">
