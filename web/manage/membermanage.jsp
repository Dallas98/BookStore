        ...
        <td align="center" valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="1089" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>会员列表</b>
                    </td>
            ...
            <table width="96%" height="48" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF"
                ...
                <tr style="padding:5px;">
                    <td height="24" align="center"><a href="member_detail.jsp?ID=<%=ID%>"><%=username%>
                    </a>&nbsp;
                    </td>
                ...
                <tr>
                    <td height="27" align="right">当前页数：[<%=Page%>/<%=maxPage%>]&nbsp;
                        ...
                        <%
                            ...
                            if (Page < maxPage) {
                        %>
                        　<a href="membermanage.jsp?Page=<%=Page+1%>">下一页</a>　<a
                                href="membermanage.jsp?Page=<%=maxPage%>">最后一页&nbsp;</a>
                        <%
                            }
                        %></td>
                </tr>
