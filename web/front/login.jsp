    ...
    <div class="row">
        ...
        <div id="mr-content" class="mr-content col-xs-12">
            <div class="login-wrap" style="margin-bottom: 60px; margin-top: 50px">
                ...
                <div class="login">
                    <div class="page-header" style="pause: none;"><h1 class="login_h1">会员登录</h1></div>
                    <!-- 会员登录表单 -->
                    <form action="login_check.jsp" method="post" class="form-horizontal">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 control-label">
                                    <label id="password-lbl1" for="password" class="required">密码 ：</label>
                                </div>
                                <div class="col-sm-8">
                                    <!-- 密码文本框 -->
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 control-label">
                                    <label id="password-lbl2" for="password" class="required">验证码 ：</label>
                                </div>
