            ...
            <div class="registration col-sm-6 col-sm-offset-3">
                ...
                <form id="member-registration" action="modifyMember_deal.jsp"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 control-label">
                                <label id="password-lbl6" for="password-lbl6" class="required">
                                    邮箱 ：</label>
                            </div>
                            <div class="col-sm-8" style="clear: none;">
                                <!-- 输入邮箱的文本框 -->
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8" style="margin-left: 150px;"><input name="ID"
                                                                                                     type="hidden"
                                                                                                     value="<%=id%>">
                                <button type="submit" class="btn btn-primary pull-left" style="width:100px;">提交</button>
                                <button type="button" onclick="javascript:history.go(-1)"
                                        class="btn btn-primary pull-left" style="width:100px;">取消
                                </button>
                            </div>
                        </div>
                    </fieldset>
